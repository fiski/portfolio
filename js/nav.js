        ...
        <div class="nav-right">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="assets/images/maximilian-relam-wide-CV-1page.pdf" class="dropdown-item" target="_blank">English</a>
                    <a href="assets/images/maximilian-relam-wide-CV-1sida.pdf" class="dropdown-item" target="_blank">Swedish</a>
                </div>
            </div>
        </div>
    `;
